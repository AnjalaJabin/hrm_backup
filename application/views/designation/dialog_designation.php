      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <select name="department_id" id="select2-demo-6" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_select_department');?>...">
            ...
            ?>
            <option value="<?php echo $department->department_id?>" <?php if($department->department_id==$department_id) {?> selected="selected" <?php } ?>><?php echo $department->department_name.' - '.$company_name; ?></option>
            <?php } ?>
          </select>
        </div>
      </div>

...
<?php $favicon = base_url().'uploads/logo/favicon/favicon.ico';?>
<!DOCTYPE html>
<html lang="en">
<head>
    <!-- Meta tags -->
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>skin/vendor/DataTables/Buttons/css/buttons.dataTables.min.css">
        <link rel="stylesheet" href="<?php echo base_url();?>skin/vendor/DataTables/select/datatables.select.min.css">
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>skin/vendor/daterangepicker/daterangepicker.css">

    <!-- CSS -->
    <link rel="stylesheet" href="<?php echo base_url();?>skin/css/core.css">
    <link rel="stylesheet" href="<?php echo base_url();?>skin/css/style.css?v=<?php echo time(); ?>">

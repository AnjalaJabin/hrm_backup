...
<?php $logo_second = base_url().'uploads/logo/logo-hrm.png';?>
<?php $logo = base_url().'uploads/logo/corbuz.svg';?>
<style type="text/css">
...
<script type="text/javascript" src="<?php echo base_url();?>skin/vendor/moment/moment.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>skin/vendor/daterangepicker/daterangepicker.min.js"></script>
...
<script type="text/javascript" src="<?php echo base_url();?>skin/vendor/DataTables/select/datatables.select.min.js"></script>

<script type="text/javascript" src="<?php echo base_url();?>skin/vendor/DataTables/Buttons/js/buttons.colVis.min.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>skin/vendor/DataTables/JSZip/jszip.min.js"></script>
...
<script type="text/javascript" src="<?php echo base_url().'skin/js_module/'.$path_url.'.js'; ?>?v=<?php echo time(); ?>"></script>
<script type="text/javascript" src="<?php echo base_url().'skin/js_module/set_clocking.js'; ?>"></script>
<script type="text/javascript" src="<?php echo base_url().'skin/js_module/custom.js?ver='.time(); ?>"></script>
...
elseif($path_url=='employees_detail')
{
?>
<script type="text/javascript" src="<?php echo site_url(); ?>skin/document/employee_ind.js"></script>
<script type="text/javascript" src="<?php echo site_url(); ?>skin/document/jquery.form.js"></script>
<?php
}
elseif($path_url=='profile')
{
?>
<script type="text/javascript" src="<?php echo site_url(); ?>skin/document/profile_ind.js"></script>
<script type="text/javascript" src="<?php echo site_url(); ?>skin/document/jquery.form.js"></script>
<?php
}
?>
...
<script type="text/javascript" src="<?php echo site_url(); ?>skin/js/tour-script.js"></script>
--> 

...
<div class="row m-b-1" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
    <div class="col-md-6">
    ...
    <?php if(in_array('32',$role_resources_ids)) { ?>
        <div class="col-md-6">
            <div class="box box-block bg-white">
                ...
                <form action="<?php echo site_url("employee/annual_leave/update_leave_status").'/'.$leave_id;?>/" method="post" name="update_status" id="update_status">

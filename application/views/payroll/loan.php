...
<div class="add-form" style="display:none;">
  <div class="box box-block bg-white">
    ...
    <div class="row m-b-1">
      <div class="col-md-12">
        <form class="m-b-1" action="<?php echo site_url("payroll/add_loan") ?>" method="post" name="add_loan" id="xin-form">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" placeholder="<?php echo $this->lang->line('xin_employee_monthly_installment');?>" name="monthly_installment" type="text">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">

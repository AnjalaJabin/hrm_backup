...
if(isset($_GET['jd']) && isset($_GET['ticket_id']) && $_GET['data']=='ticket'){
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="edit-modal-data">Edit Compensatory Leave Details</h4>
    </div>
    <form class="m-b-1" action="<?php echo site_url("compoff/update").'/'.$id; ?>" method="post" name="edit_ticket" id="edit_compoff">
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="days" class="control-label">Leave days</label>
                        <input id="days" class="form-control" placeholder="Leave Days" value="<?php echo $leave_no;?>" name="days" type="number" value="">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="ticket_date" class="control-label">Status</label>
                        <select class="form-control"  name="status" data-plugin="select_hrm" data-placeholder="Employee" >
                            <option value="1" <?php if($status==1):?> selected <?php endif;?>>Open</option>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control textarea" placeholder="Description" name="description" cols="30" rows="5" id="description2"><?php echo $remarks;?></textarea>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var xin_table = $('#xin_table_details').dataTable({
                "bDestroy": true,
                dom: 'Blfrtip',
                buttons: [
            ...
            /* Edit data */
            $("#edit_compoff").submit(function(e){
                e.preventDefault();
                ...
                $.ajax({
                    type: "POST",
                    url: e.target.action,
                    data: obj.serialize()+"&is_ajax=1&edit_type=compoff&form="+action+"&description="+description,
                    cache: false,

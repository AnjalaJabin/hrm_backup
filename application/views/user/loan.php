...
<div class="add-form" style="display:none;">
  <div class="box box-block bg-white">
    <h2><strong><?php echo $this->lang->line('xin_request');?></strong> Loan
    ...
    <div class="row m-b-1">
      <div class="col-md-12">
        <form class="m-b-1" action="<?php echo site_url("employee/payroll/add_loan") ?>" method="post" name="add_loan" id="xin-form">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="end_date">EMI</label>
                        <input class="form-control" placeholder="EMI" name="monthly_installment" type="text">
                      </div>
                    </div>
                  </div>
                  <div class="row">
...
<div class="box box-block bg-white">
  <h2><strong><?php echo $this->lang->line('xin_list_all');?></strong> Loans
    <div class="add-record-btn">

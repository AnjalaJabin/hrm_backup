            ...
            <div class="box-block">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-control" name="location_id" data-placeholder="<?php echo $this->lang->line('xin_location');?>">
                    <option value=""><?php echo $this->lang->line('xin_select_one');?></option>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="department_id" data-placeholder="<?php echo $this->lang->line('xin_department');?>">
                          <option value=""><?php echo $this->lang->line('xin_select_one');?></option>

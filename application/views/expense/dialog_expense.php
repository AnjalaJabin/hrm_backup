    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          <label for="employee">Expense Category</label>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input class="form-control" placeholder="<?php echo $this->lang->line('xin_amount');?>" name="amount" type="text" value="<?php echo round($amount,2);?>">
            </div>
          </div>
        </div>
        <div class="row">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <select name="status" id="select2-demo-6" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('dashboard_xin_status');?>...">
            ...
            <option value="2" <?php if($status=='2'):?> selected <?php endif; ?> >Paid</option>
            <option value="2" <?php if($status=='3'):?> selected <?php endif; ?> >Rejected</option>
          </select>
        </div>
      </div>
      <div class="col-md-6">

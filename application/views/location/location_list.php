...
/* Location view
*/
$list_count = $this->Xin_model->get_all_locations();
if($list_count==0)
{
    $style='';
}
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="company" data-placeholder="<?php echo $this->lang->line('module_company_title');?>">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <div class="row">
                      <div class="col-md-6">
                    	...
                    	<select class="form-control" name="location_head" data-placeholder="<?php echo $this->lang->line('xin_view_locationh');?>">
                      <option value=""><?php echo $this->lang->line('xin_select_one');?></option>
                      ...
                      <div class="col-md-6">
                        ...
                        <select class="form-control" name="location_manager" data-placeholder="<?php echo $this->lang->line('xin_view_locationmgr');?>">
                      <option value=""><?php echo $this->lang->line('xin_select_one');?></option>
                      <?php foreach($all_employees as $employee) {?>
                      <option value="<?php echo $employee->user_id;?>"> <?php echo $employee->first_name.' '.$employee->last_name;?></option>
                      <?php } ?>
                  ...
                  <div class="form-group">
                    ...
                    <br>
                    <select class="form-control" name="country"  data-placeholder="<?php echo $this->lang->line('xin_country');?>">
                      <option value=""><?php echo $this->lang->line('xin_select_one');?></option> 

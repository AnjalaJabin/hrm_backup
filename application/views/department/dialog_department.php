...
<form class="m-b-1" action="<?php echo site_url("department/update").'/'.$department_id; ?>" method="post" name="edit_department" id="edit_department">
  ...
  <div class="modal-body">
      ...
      <div class="form-group">
        ...
        ?>
        <option value="<?php echo $location->location_id;?>" <?php if($location_id==$location->location_id):?> selected="selected"<?php endif;?>> <?php echo $location->location_name.' - '.$company_name;?></option>
        <?php } ?>
        </select>
        </div>
        <div class="form-group">

...
class Designation extends MY_Controller {
    ...
    public function designation_list()
     {
		...
		$data = array();
          ...
          foreach($designation->result() as $r) {
			  ...
			  $company_data = $this->Xin_model->get_company_by_department($r->department_id);
			  ...
			  $full_name = $user[0]->first_name.' '.$user[0]->last_name;
               ...
               $data[] = array(
                    ...
                    $r->designation_name,
                    $department[0]->department_name.' - '.$company_name,
					$full_name
               );
          }
	...
	public function delete() {
		...
		$delete_check = $this->Xin_model->designation_delete_check($id);
		if($delete_check>=1)
		{
		    $Return['error'] = "You can't delete this designation. Because some data are associated under this designation";
		}
		else
		{

...
function editcapt(capt,id,root_id,user_id)
{
	...
	xmlhttp.open("GET","documents_upload/controller/edit_caption.php?id="+id+"&cpt="+capt+"&root_id="+root_id+"&user_id="+user_id,true);
	xmlhttp.send();
}
function delpic(img_id,root_id,user_id)
{
    if(confirm("Are you sure you want to delete this file?")) {
    	...
    	xmlhttp.open("GET","documents_upload/controller/delpic_action.php?img_id="+img_id+"&root_id="+root_id+"&user_id="+user_id,true);
    	xmlhttp.send();
    }
}
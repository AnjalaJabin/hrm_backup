...
var $sql;
	...
	function insertgal($smlimg,$actimg,$filesize,$root_id,$user_id)
	{
		$this->getconnect();
		$sql="insert into xin_document_files(img_name,img_list_name,root_id,uid,time,filesize) values('$actimg','$smlimg','$root_id','$user_id','".time()."','$filesize')";
		mysql_query($sql);
	}

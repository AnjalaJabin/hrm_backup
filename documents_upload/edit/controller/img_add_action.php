...
$document_id = $_POST['document_id'];
	...
	while($j<=$array-1)
	{
		...
		$oper->insertgal($filename,$act_img,$filesize,$root_id,$user_id,$document_id);
	$j=$j+1;
	}
	?>
       <?php    
                $query = "select * from xin_document_files WHERE document_id='".$document_id."' and root_id='".$root_id."' order by id DESC";

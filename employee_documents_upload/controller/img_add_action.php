...
$employee_id = $_POST['employee_id'];
	...
	for($j=0; $j<=$array-1; $j++)
	{
		...
		$oper->insertgal($filename,$act_img,$filesize,$root_id,$user_id,$employee_id);
	}
	?>
       <?php    
                $query = "select * from xin_employee_document_files WHERE document_id='' and root_id='".$root_id."' and uid='".$user_id."' order by id DESC";

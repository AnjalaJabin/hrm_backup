...
$oper->delimg($img_id,$root_id,$employee_id); 

                $query = "select * from xin_employee_document_files WHERE document_id='' and root_id='".$root_id."' and employee_id='".$employee_id."' order by id DESC";
